    ...
    if (user?.role === "university") {
      return [
        ...
        },
        {
          icon: Megaphone,
          label: "Create Alert",
          href: "/dashboard/university/alerts/create",
        },
      ];
    }
  ...
  return (
    ...
    >
      ...
      <div className="p-4 flex items-center justify-between border-b border-border/50 h-16">
        {!isCollapsed && (
          ...
          >
            ...
            <span className="font-bold text-lg text-nowrap overflow-hidden cursor-pointer">
              CampusHire
            </span>
          </motion.div>
        )}
      ...
      <div className="p-4 border-t border-border/50">
        ...
        >
          <div
            className={`rounded-2xl p-4 bg-gray-200 w-8 h-8 flex justify-center items-center`}
          >
